...
import time
from Shopee_dataset import dimension_dict, loaders_dict
...
if __name__ == "__main__":
    ...
    sol_per_pop = 3 # The number of solutions per step in GA
    ...
    early_fusion_loss, early_fusion_dict_log = early_fusion(dimension_dict, loaders_dict, device, lr, num_epochs, criterion)
    end_time_early_fusion = time.time()
    print("-----------------------------------------------------Start of late fusion---------------------------------------------------------------------")
    start_time_late_fusion = time.time()
    late_fusion_loss, late_fusion_dict_log = late_fusion(dimension_dict, loaders_dict, device, lr, num_epochs, criterion)
    ...
    brute_force_solution, intermediate_brute_force_loss = intermediate_fusion_brute_force_search(dimension_dict, loaders_dict, device, lr, num_epochs, criterion)
    end_time_brute_force_search = time.time()
    print("---------------------------------------------Start of intermediate fusion with GA-------------------------------------------------------------")
    start_time_GA = time.time()
    solution_GA, intermediate_fusion_loss_GA = intermediate_fusion_GA(dimension_dict, loaders_dict, device, lr, num_epochs, num_generations, sol_per_pop, num_parents_mating, criterion)
